...
class ExcaSatOneClass(CustomDataset):
    ...
    def __init__(self,
        ...
        super(ExcaSatOneClass, self).__init__(ann_file, pipeline, **kwargs)
    ...
    def load_annotations(self, ann_folder):
        ...
        """
        cls_map = {'excavator': 0}  # in mmdet v2.0 label is 0-based
        print(cls_map)
